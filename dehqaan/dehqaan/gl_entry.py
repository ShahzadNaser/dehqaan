...
def update_payment_entry(self, method):
    if self.voucher_type == 'Payment Entry':
            ...
            if account_type == 'Receivable' or account_type == 'Payable':
                if self.against_voucher_type == 'Purchase Invoice' or self.against_voucher_type == 'Purchase Order' or self.against_voucher_type == 'Journal Entry' or self.against_voucher_type == 'Sales Invoice':
